...
class VOCEvaluator():
    ...
    def __init__(
        self, data_root, device, transform, 
        labelmap=VOC_CLASSES, set_type='test', 
        year='2007', display=False
        ):
        ...
        # dataset
        self.dataset = VOCDetection(data_root=data_root,
