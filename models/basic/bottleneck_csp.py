...
class Bottleneck(nn.Module):
    # Standard bottleneck
    def __init__(self, c1, c2, shortcut=True, d=1, e=0.5, depthwise=False, norm_type='BN', act_type='relu'):
...
class BottleneckCSP(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=True, e=0.5, depthwise=False, norm_type='BN', act_type='relu'):
